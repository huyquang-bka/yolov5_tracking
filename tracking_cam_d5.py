...
from Wang.object_counting import object_counting_down_d5, object_counting_up_d5
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        while True:
            ...
            alpha = 0.7
            img0_copy = img0.copy()
            up_key = object_counting_up_d5(old_dict, spot_dict)
            down_key = object_counting_down_d5(old_dict, spot_dict)
            print(up_key)
            ...
            for key, value in spot_dict.items():
                ...
                cv2.putText(img0, str(str(id).upper()), (x1 + 20, y1 + 20), cv2.FONT_HERSHEY_COMPLEX, 1,
                            (255, 255, 255), 2)
            for k, v in spot_dict_d5_copy.items():
                x, y, w, h, status = v
                if status == 0:
            ...
            # cv2.line(img0, (0, 200), (1180, 200), (0, 0, 255), 2)
            # cv2.line(img0, (0, 200 + 325), (1180, 200 + 325), (0, 0, 255), 2)
            # cv2.line(img0, (1180, 0), (1180, H), (0, 0, 255), 2)
